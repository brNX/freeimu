...
public:  
  ...
  void init(unsigned char _BMPMode, int32_t _initVal, bool _centimeters);   // sets a reference datum
  ...
  void setMode(unsigned char _BMPMode);                   // BMP085 mode
  // initialization
  ...
  unsigned char _buff[BUFFER_SIZE];                      // buffer  MSB LSB XLSB
