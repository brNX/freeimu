...
void BMP085::init(unsigned char _BMPMode, int32_t _initVal, bool _Unitmeters){
...
unsigned char BMP085::getDevAddr() {
	return _dev_address;
}

unsigned char BMP085::getMode(){
	return _oss;
}

void BMP085::setMode(unsigned char _BMPMode){
	_oss = _BMPMode;
}
...
void BMP085::calcTrueTemperature()
{
	...
	delayMSec(5);                          // min. 4.5ms read Temp delay
...
void BMP085::calcTruePressure(long *_TruePressure) {
	...
	delayMSec(_pressure_waittime[_oss]);
